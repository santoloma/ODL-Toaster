 ...
 */
package org.opendaylight.toaster.cli.commands;
...
public class ToasterCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(ToasterCliTestCommand.class);
    protected final ToasterCliCommands service;

    public ToasterCliTestCommand(final ToasterCliCommands service) {
